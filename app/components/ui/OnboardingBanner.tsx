  ...
  return (
    <div className="fixed bottom-6 inset-x-4 md:bottom-8 md:right-8 md:left-auto md:w-[450px] z-[100] animate-fade-in-up hover-lift">
      <div className="relative overflow-hidden bg-card/90 backdrop-blur-3xl border border-primary/30 rounded-3xl p-6 shadow-[0_20px_60px_-15px_rgba(14,165,233,0.5)]">
        ...
        <button 
          onClick={handleClose}
          className="absolute top-4 right-4 text-muted-foreground hover:text-foreground bg-muted hover:bg-muted/80 p-1.5 rounded-full transition-all focus-ring"
        ...
        <div className="flex gap-4 relative z-10">
          ...
          <div className="space-y-2">
            ...
            <button 
              ...
              className="mt-4 flex items-center gap-2 text-sm font-bold text-primary hover:text-foreground transition-colors group"
            >
